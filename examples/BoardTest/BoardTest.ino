...
Mega2560     Uno Pin    CC3000 Board    Function
 
 VCC or +5V   +5V        VCC or +5V      5V
 GND          GND        GND             GND
 D11          2          INT             Interrupt
 D49          7          EN              WiFi Enable
 53           10         CS              SPI Chip Select
 MOSI         11         MOSI            SPI MOSI
 MISO         12         MISO            SPI MISO
...
// Pins
#define CC3000_INT      0   // Needs to be an interrupt pin (D2/D3)
